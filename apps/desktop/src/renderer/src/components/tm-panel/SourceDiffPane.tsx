...
function DiffLine({
  ...
  return (
    <p className="content-text whitespace-pre-wrap break-words text-reference leading-relaxed text-text">
      {parts
...
export function SourceDiffPane({
  ...
  return (
    <div className="h-full min-h-0 flex flex-col bg-surface">
      ...
      >
        <div className="mb-1.5 text-reference-meta font-semibold uppercase tracking-wider text-text-faint">
          TM source
        </div>
        <DiffLine parts={parts} visibleChange="remove" />
      </section>
      <section
        className="quiet-scrollbar min-h-0 flex-1 overflow-y-auto border-t border-border-subtle px-3 py-3"
