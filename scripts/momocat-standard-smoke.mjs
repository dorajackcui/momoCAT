...
function loadSmokeConfig(configPath) {
  if (!existsSync(configPath)) {
    ...
    console.error("This local config is gitignored; keep machine paths and provider endpoints there.");
    process.exit(1);
  }
  ...
  return {
    ...
    outputDir: raw.outputDir ? resolvePath(requiredString(raw.outputDir, "outputDir")) : path.join(repoRoot, "testoutput"),
