...
const scriptPath = path.join(repoRoot, 'scripts', 'tb-match-flow-trace.mjs');

test('tb match flow trace script exposes help', () => {
  ...
  assert.match(result.stdout, /tb-match-flow-trace\.mjs/);
