...
export const PROJECT_AI_MODELS = Object.keys(
...
export function isBuiltinProjectAIModel(
  value: string | null | undefined,
): value is BuiltinOpenAIProviderId {
  return typeof value === "string" && PROJECT_AI_MODEL_SET.has(value);
}

export function isLegacyProjectAIModel(
  value: string | null | undefined,
): value is keyof typeof LEGACY_MODEL_TO_PROVIDER_ID {
...
export function toBuiltinProviderId(
  value: string | null | undefined,
): BuiltinOpenAIProviderId | null {
  if (!value) {
    return null;
  }
